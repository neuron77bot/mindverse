...
export default function ImageUpload({ onUploadSuccess }: ImageUploadProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-slate-700 p-6 shadow-xl">
      ...
      {/* Tag Input */}
      <div className="mb-4">
        <label className="block text-sm text-slate-400 mb-2">Tag de referencia *</label>
        <input
          type="text"
          value={tag}
        ...
        />
        <p className="text-xs text-slate-500 mt-1">Todas las imágenes compartirán este tag</p>
      </div>
